...
export const D3SvgOverlay = (L.version < '1.0' ? L.Class : L.Layer).extend({
  ...
  onAdd: function (map) {
    ...
    this.projection.pathFromGeojson = d3.geo
      .path()
      .projection(d3.geo.transform({ point: this.projection._projectPoint }))
